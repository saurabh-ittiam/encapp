...
struct EncoderX264: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    
    var preset: String {
        get {return _preset ?? "medium"}
    ...
    var colorSpace: String {
        get {return _colorSpace ?? "yuv420p"}
    ...
    fileprivate var _bitdepth: Int32? = nil
...
struct Test: @unchecked Sendable {
    ...
    var encoderX264: EncoderX264 {
        get {return _storage._encoderX264 ?? EncoderX264()}
        set {_uniqueStorage()._encoderX264 = newValue}
    }
    /// Returns true if `encoderX264` has been explicitly set.
    var hasEncoderX264: Bool {return _storage._encoderX264 != nil}
    /// Clears the value of `encoderX264`. Subsequent reads from it will return its default value.
    mutating func clearEncoderX264() {_uniqueStorage()._encoderX264 = nil}
...
extension EncoderX264: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    static let protoMessageName: String = "EncoderX264"
    static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
        1: .same(proto: "preset"),
        2: .same(proto: "colorSpace"),
        3: .same(proto: "bitdepth"),
        4: .same(proto: "outputFile"),
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try { try decoder.decodeSingularStringField(value: &self._preset) }()
            case 2: try { try decoder.decodeSingularStringField(value: &self._colorSpace) }()
            case 3: try { try decoder.decodeSingularInt32Field(value: &self._bitdepth) }()
            case 4: try { try decoder.decodeSingularStringField(value: &self._outputFile) }()
            case 5: try { try decoder.decodeSingularInt32Field(value: &self._threads) }()
            default: break
            }
        }
    }
    ...
    static func ==(lhs: EncoderX264, rhs: EncoderX264) -> Bool {
...
extension Test: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    fileprivate class _StorageClass {
        ...
        var _encoderX264: EncoderX264? = nil
        ...
        init(copying source: _StorageClass) {
            ...
            _encoderX264 = source._encoderX264
        }
    }
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
            while let fieldNumber = try decoder.nextFieldNumber() {
                ...
                case 8: try { try decoder.decodeSingularMessageField(value: &_storage._encoderX264) }()
                default: break
                }
            }
        }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
            ...
            try { if let v = _storage._encoderX264 {
    ...
    static func ==(lhs: Test, rhs: Test) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._encoderX264 != rhs_storage._encoderX264 {return false}
                return true
            }
            if !storagesAreEqual {return false}
        }
